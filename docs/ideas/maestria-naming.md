...
- **Maestro** (Italian) = the master, the conductor
- **Maestria** (Spanish/Italian/Portuguese) = mastery, skill, expertise

Maestria is the noun form of Maestro — it names the *capability*, not the person.

Hidden layer: **-ia** is **AI** reversed. Mastery for AI, encoded in the name itself.

## Brand Positioning

| Project | What it means |
|---|---|
| **Superpowers** (obra) | "You get powers" — gifted, heroic |
